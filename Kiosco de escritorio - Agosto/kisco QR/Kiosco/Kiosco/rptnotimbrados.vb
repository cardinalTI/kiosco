...
Public Class rptnotimbrados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kiosco.rptnotimbrados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptnotimbrados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptnotimbrados = New rptnotimbrados()
        rpt.Site = Me.Site
        Return rpt
    End Function
