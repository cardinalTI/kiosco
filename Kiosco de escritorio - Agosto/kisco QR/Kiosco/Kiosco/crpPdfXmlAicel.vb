...
Public Class crpPdfXmlAicel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kiosco.crpPdfXmlAicel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpPdfXmlAicel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpPdfXmlAicel = New crpPdfXmlAicel()
        rpt.Site = Me.Site
        Return rpt
    End Function
