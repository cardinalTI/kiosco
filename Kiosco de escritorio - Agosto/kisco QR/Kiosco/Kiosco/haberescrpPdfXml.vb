...
Public Class haberescrpPdfXml
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kiosco.haberescrpPdfXml.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedhaberescrpPdfXml
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As haberescrpPdfXml = New haberescrpPdfXml()
        rpt.Site = Me.Site
        Return rpt
    End Function
